...
// Validación de DNI/NIE (modificada para aceptar NIE)
...
// MODIFICADA: Validación de DNI/NIE (acepta letras y números)
function validarDNI(e) {
    const input = e.target;
    // Permitir letras y números, convertir a mayúsculas
    input.value = input.value.toUpperCase().replace(/[^A-Z0-9]/g, '');
    
    // No limitamos la longitud máxima, pero podemos establecer un máximo razonable
...
// ============================================
// FUNCIÓN DE FICHAJE (MODIFICADA PARA ACEPTAR DNI/NIE)
// ============================================
...
function fichar() {
    ...
    // Validar DNI/NIE (ahora acepta letras y números, mínimo 5 caracteres)
...
// ============================================
// FUNCIONES DE GERENCIA ACTUALIZADAS (CONTRASEÑA CAMBIADA A "0122")
// ============================================

function accederGerencia() {
    // CAMBIO: Contraseña cambiada de "369" a "0122"
...
// ============================================
// GESTIÓN DE USUARIOS - MODIFICADA PARA ACEPTAR DNI/NIE
// ============================================
...
function agregarUsuario() {
    ...
    // Validar DNI/NIE (acepta letras y números)
    if (!dni || dni.length < 5 || !/^[A-Z0-9]{5,12}$/.test(dni)) {
